...
public:
	...
	union { Type x; Type r; Type s; Type _0; Type row; };

	union { Type y; Type g; Type t; Type _1; Type col; };
...
union { Type x; Type r; Type s; Type _0; };

union { Type y; Type g; Type t; Type _1; };

union { Type z; Type b; Type u; Type _2; };
